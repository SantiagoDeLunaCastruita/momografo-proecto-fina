<<<<<<< HEAD
﻿"""Servidor principal de Momografo.
Define las rutas Flask, conexión a MongoDB y envío de correos para recuperación de contraseña.
"""
...
try:
    ...
    logging.warning('Algunas operaciones de BD pueden fallar hasta que se configure la conexión.')
...
def normalize_tag(value):
    """Normaliza una etiqueta: trim, minúsculas y espacios colapsados."""
    return ' '.join(value.strip().lower().split())


def parse_tags(value):
    """Convierte un campo de etiquetas separadas por comas en una lista única."""
    tags = []
...
>>>>>>> b852869a79d40015747354619dbfe581f071b692
    app.run(debug=True)
